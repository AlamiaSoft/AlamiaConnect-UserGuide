...
### Create Products in AlamiaConnect

**Step-1** Go to admin panel of AlamiaConnect and click on **Products >> Create Product** as shown in the below image.
...
If you want to delete an unnecessary Products from your AlamiaConnect CRM, in the action click on **Delete** button, as shown in the below image.

![Delete Grid](../../assets/2.x/images/product/deleteProduct.png)

**C) View Products**

If you want to view a Product or make some edits like if you want to add **Files, Notes** from your AlamiaConnect CRM, in the action click on **View** button and easily add the Files, Notes, and the data will get visible in **Notes, Files and All** sections respectively as shown in the below image.

![Grid](../../assets/2.x/images/product/viewProduct.png)

**NOTE-** These products can be assigned while creating a lead. 

By following the above steps you can easily create quotes in AlamiaConnect CRM.
