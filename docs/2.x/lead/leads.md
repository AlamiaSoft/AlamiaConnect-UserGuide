...
A **Lead** is a potential customer or prospect. Generating a lead is the first step of the sales process in AlamiaConnect CRM. Lead records are designed to store all known information on the lead, including company name, address, contact details, and the lead's current position in the sales funnel.

---

## Create Leads in AlamiaConnect

### Manual Lead Creation

**Step-1** Go to the admin panel of AlamiaConnect and click on  
**Leads >> Create Lead**.
...
### Upload File to Create Leads (Alamia AI Hub)

AlamiaConnect CRM also supports **document-based lead creation** using Alamia AI Hub.
...
Once uploaded, Alamia AI Hub will automatically extract details (e.g., Name, Email, Phone, Organization) and create a new lead.
...
> 🔗 *Note: This feature requires Alamia AI Hub and DOC Generation to be enabled in*  
> **Settings >> Configuration >> Alamia AI Hub**
...
By following the above steps, you can easily create and manage leads in AlamiaConnect CRMâ€”either manually or automatically using document upload with Alamia AI.
