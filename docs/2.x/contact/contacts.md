...
### Create person in AlamiaConnect

**Step-1** Go to admin panel of AlamiaConnect and click on **Contacts >> Persons >> Create Person** as shown in the below image.
...
### Create organizations in AlamiaConnect

**Step-1** Go to admin panel of AlamiaConnect and click on **Contacts >> Organizations >> Create Organization** as shown in the below image.
...
By following the above steps you can easily create Persons & Organizations in AlamiaConnect CRM.